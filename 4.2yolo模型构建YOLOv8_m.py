...
OUTPUT_DIR = BASE_DIR / "outputs_task2_yolov8m"
...
RESULT_DIR = BASE_DIR / "outputs_task2_yolov8m" # 评估结果保存目录，包含测试集指标和检测结果图
...
def plot_training_curves():
    ...
    plt.suptitle("YOLOv8m Training Curves — RFDD", fontsize=14)
    plt.tight_layout()
...
def main():
    ...
    print(f"  训练超参数总览")
    print(f"  {'='*60}")
    print(f"  YOLO 版本:    YOLOv8m (ultralytics)")
    print(f"  Backbone:     CSPDarknet (25.9M 参数)")
    print(f"  输入尺寸:     {CONFIG['imgsz']}×{CONFIG['imgsz']}")
